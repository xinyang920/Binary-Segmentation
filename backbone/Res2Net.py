...
class Res2Net(nn.Module):
    ...
    def __init__(self, block=Bottle2neck, layers=[3, 4, 6, 3], baseWidth=26, scale=4, num_classes=1000):
        self.inplanes = 64
    ...
    def initialize(self):
        # self.load_state_dict(torch.load('../res/pvt_v2_b2.pth'), strict=False)
        pass
